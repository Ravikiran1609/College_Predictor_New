...
# Run and export
df = pd.DataFrame(parse_pdf("ENGG_CUTOFF_2024_HK_EXT_RNDkannada.pdf"))
df.to_csv("ENGG_CUTOFF_2024_HK_EXT_RNDkannada.csv", index=False)
print("✅ ENGG_CUTOFF_2024_HK_EXT_RNDkannada.csv created successfully.")
