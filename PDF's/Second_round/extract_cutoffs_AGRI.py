...
# Use like this:
df = pd.DataFrame(parse_agri_pdf("agri_cutoff_2024_hk_r2_FIN.pdf"))
df.to_csv("agri_cutoff_2024_hk_r2_FIN.csv", index=False)
print("✅ agri_cutoff_2024_hk_r2_FIN.csv created successfully.")
